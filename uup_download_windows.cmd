@echo off
:: Generated on 2026-03-01 08:45:55 GMT
...
:START_PROCESS
title 26100.1000_amd64_en-us_professional_0cda15f9 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=0cda15f9-a14a-4adf-bb3c-2ce79d0de621&pack=en-us&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
